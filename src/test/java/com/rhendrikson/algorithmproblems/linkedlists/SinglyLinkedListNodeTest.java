...
public class SinglyLinkedListNodeTest {
    ...
    public void testAppend() {
        SinglyLinkedListNode<Integer> linkedList = new SinglyLinkedListNode<Integer>(1, null);
        linkedList.append(2);
    ...
    public void testEquals() {
        SinglyLinkedListNode<Integer> linkedList1 = new SinglyLinkedListNode<Integer>(1, 2, 3, 4, 5);
        SinglyLinkedListNode<Integer> linkedList2 = new SinglyLinkedListNode<Integer>(1, 2, 3, 4, 5);
    ...
    public void testNotEquals() {
        SinglyLinkedListNode<Integer> linkedList1 = new SinglyLinkedListNode<Integer>(1, 2, 3, 4, 5);
        SinglyLinkedListNode<Integer> linkedList2 = new SinglyLinkedListNode<Integer>(5, 4, 3, 2, 1);
